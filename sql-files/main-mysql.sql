...
#
# Main_MySQL.sql
# MySQL 5.0 Database Creation Script
...
CREATE TABLE `char` (
  ...
  `base_level` tinyint(4) unsigned NOT NULL default '1',
  `job_level` tinyint(4) unsigned NOT NULL default '1',
...
CREATE TABLE `mail_data` (
  `char_id` int(11) NOT NULL default '0',
  `mail_num` int(11) NOT NULL default '0',
  ...
  `body_size` int(11) unsigned NOT NULL default '0',
