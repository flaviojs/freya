...
(
  ...
  `char_num` smallint(1) NOT NULL default '0',
...
(
  ...
  `account_id` int(11) NOT NULL default '0',
  `char_num` smallint(4) NOT NULL default '0',
...
(
  ...
  `connect_member` smallint(2) NOT NULL default '0',
  `max_member` smallint(2) NOT NULL default '0',
