...
INSERT INTO `item_db` VALUES (1758, 'Stun_Arrow', 'Stun Arrow', 10, 10, 0, 3, 1, 0, 0, 0, 1706056, 2, 32768, 0, 1, 0, NULL, 'bonus2 bAddEff,Eff_Stan,500;');
...
INSERT INTO `item_db` VALUES (2115, 'Valkyrie\'s_Shield', 'Valkyrie\'s Shield', 5, 30000, 0, 500, 0, 3, 0, 1, 1071636478, 2, 32, 0, 65, 3, NULL, 'bonus2 bSubEle,1,20; bonus2 bSubEle,3,20; bonus2 bSubEle,7,20; bonus2 bSubEle,9,20; if(isequipped(2353,5124)==0)end;bonus bMdef,5; end; bonus bDef,2; bonus bMdef,25;');
...
INSERT INTO `item_db` VALUES (2418, 'Vidar\'s_Boots', 'Vidar\'s Boots', 5, 30000, 15000, 650, 0, 4, 0, 0, 1071636478, 2, 64, 0, 65, 0, NULL, 'bonus bMaxHPrate,9; bonus bMaxSPrate,9; if(isequipped(2353,2516)==0) end; bonus bAgi,3; bonus bMaxHPrate,5; bonus bMaxSPrate,5;');
...
INSERT INTO `item_db` VALUES (2657, 'Laboratory_Passport', 'Laboratory Passport', 5, 20, 0, 100, 0, 0, 0, 0, 1071636479, 2, 136, 0, 1, 0, NULL, NULL);
...
INSERT INTO `item_db` VALUES (4406, 'Skeggjold_Card', 'Skeggjold Card', 6, 0, 10, 10, 0, 0, 0, 0, 0, 2, 2, 0, 0, 0, NULL, 'bonus2 bMagicAddEle,6,100;');
INSERT INTO `item_db` VALUES (4407, 'Valkyrie_Randgrith_Card', 'Valkyrie Randgrith Card', 6, 0, 10, 10, 0, 0, 0, 0, 0, 2, 2, 0, 0, 0, NULL, 'bonus4 bAutoSpell,289,1,1000,1;');
...
INSERT INTO `item_db` VALUES (5104, 'Dark_Blinder', 'Dark Blinder', 5, 20, 0, 100, 0, 0, 0, 0, 1071636478, 2, 512, 0, 0, 187, NULL, 'bonus2 bResEff,Eff_Blind,10000; bonus2 bResEff,Eff_Stan,200;');
...
INSERT INTO `item_db` VALUES (5151, 'Musical_Note_Headphone', 'Musical Note Headphones', 5, 20, 10, 200, 0, 4, 0, 1, 1071636479, 2, 768, 0, 0, 220, NULL, 'bonus bMdef,3; bonus2 bResEff,Eff_Stan,1000; bonus2 bResEff,Eff_Freeze,1000;');
INSERT INTO `item_db` VALUES (5152, 'Phoenix_Coronet', 'Phoenix Coronet', 5, 20, 10, 2000, 0, 2, 0, 0, 1071636479, 2, 768, 0, 0, 221, NULL, 'bonus bInt,1; bonus2 bResEff,Eff_Stan,1000;');
...
INSERT INTO `item_db` VALUES (5173, 'Hat_of_the_Judge', 'Judge\'s Hat', 5, 30000, 15000, 400, 0, 3, 0, 1, 1071636479, 2, 256, 0, 60, 227, NULL, 'if (Class!=4046 && Class!=4047 && Class!=4048 && Class!=4049) end; bonus bAgi,1; bonus bHPrecovRate,3;');
...
INSERT INTO `item_db` VALUES (5183, 'Nest_Hat', 'Nest Hat', 5, 0, 0, 500, 0, 2, 0, 0, 1071636479, 2, 256, 0, 10, 235, NULL, 'bonus bAgi,1; bonus bDex,1; bonus2 bResEff,Eff_Stan,1000;');
