...
INSERT INTO `item_db` VALUES (4343, 'Holden_Card', 'Holden Card', 6, 0, 10, 10, 0, 0, 0, 0, 0, 2, 769, 0, 0, 0, NULL, 'bonus bLuk,2; if(isequipped(4186,4281,4036,4233)==0) end; bonus bStr,4; bonus bMaxHPrate,7; bonus bMaxSPrate,7; bonus2 bSkillAtk,42,20; bonus bSPDrainValue,2; if(Basejob!=JOB_ALCHEM) end; bonus4 bAutoSpell,111,1,100,0; bonus2 bAddMonsterDropItem,7139,100; bonus2 bAddMonsterDropItem,905,100;');
