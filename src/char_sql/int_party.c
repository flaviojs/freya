// int_party.c by [Yor] compatible with Freya RO servers.
// Copyright 2004-2005 [Yor]. This software is not free of use.
// Written authorization must be given by [Yor]
// Authorization is given to Freya RO server to use it.
