...
enum { MF_NOMEMO, MF_NOTELEPORT, MF_NOSAVE, MF_NOBRANCH, MF_NOPENALTY, MF_NOZENYPENALTY, // 0-5
	...
	MF_PVP_NIGHTMAREDROP, MT_NOGMCMD, MT_MINGMLVL // 34-36
};
...
int script_config_read(char *cfgName) {
	...
	strncpy(script_config.login_event_name, "PCLogoutEvent", 24);
	strncpy(script_config.logout_event_name, "PCLoginEvent", 24);
