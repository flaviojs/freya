...
enum {
	...
	SP_BASEJOB=90,SP_BASECLASS=91, // 90-91
	SP_CARTINFO=99,	// 99
	...
	SP_FIX_MDEF,SP_FIX_HIT,SP_FIX_CRITICAL,SP_FIX_FLEE,SP_FIX_ASPD,	// 1150-1154
	SP_FIX_SPEED,SP_ADD_FIX_CAST_RATE,SP_ADD_SKILL_HEAL_RATE,	// 1155-1557
